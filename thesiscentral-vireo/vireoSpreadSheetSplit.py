...
"""
        ...
        parser.add_argument(
            ...
            default=None,
            required=True,
            help="excel export file from vireo",
        )
        parser.add_argument(
            "--split_col",
            "-s",
            required=False,
            default=VireoSheet.CERTIFICATE_PROGRAM,
...
PRINT_COLUMNS = [
    VireoSheet.CERTIFICATE_PROGRAM,
    VireoSheet.STUDENT_NAME,
    VireoSheet.DEPARTMENT,
    VireoSheet.SUBMISSION_DATE,
    VireoSheet.ADVISORS,
    VireoSheet.DOCUMENT_TITLE,
...
def main():
    ...
    try:
        ...
        print_col_ids = [
            submissions.col_index_of(name, required=True) for name in print_col_names
        ]
